...
esttab Tab_*all_`stat' Tab*_owner*_`stat' using "tabfig/descr/descr_trsnf_disc_`stat'.tex", cells("`stat'(fmt(%5.2f))") label booktabs nonum f collabels(none) plain replace nomtitles nogap
