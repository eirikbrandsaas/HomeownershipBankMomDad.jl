...
\begin{figure}[tb]
	...
	\includegraphics[width=0.5\textwidth]{../tabfig/descr/PSID_transfers_renters_inheritance.pdf}%
	 ...
	 \caption*{\begin{footnotesize} \textit{Notes:} The left panel uses the parental-transfer data only available in the 2013 transfer supplement, while the right panel uses the transfers, gifts, and inheritances variable, which is available in all waves of the PSID. See main text for a discussion. Vertical dotted and dashed lines denote the median and means, respectively. All estimates are weighted and omit the top 5\% of transfer sizes. \end{footnotesize}}
\end{figure}
...
\begin{table}[tb]
	...
	\resizebox{\textwidth}{!}{\begin{threeparttable}
		\caption{Homeownership Policies and the role of Parental Wealth}\label{tab:policy}
		\begin{tabular}{@{}llll@{}}
